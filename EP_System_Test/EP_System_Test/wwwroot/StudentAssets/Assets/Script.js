...
let settingsMenuItem = document.querySelector('#settings-box');

// Add a click event listener to the settings menu item
settingsMenuItem.addEventListener('click', function (e) {
    ...
    if (settingsBox.style.display === 'block') {
        // If the settings box is already displayed, hide it when clicked again
        settingsBox.style.display = 'none';
    } else {
        // If the settings box is not displayed, show it
        settingsBox.style.display = 'block';
    }
});

// Add a click event listener to the document to hide the settings box when clicking outside
document.addEventListener('click', function (e) {
    if (e.target !== settingsMenuItem && e.target !== settingsBox) {
        settingsBox.style.display = 'none';
    }
});
